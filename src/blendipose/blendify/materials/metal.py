...
class MetalMaterial(PrincipledBSDFMaterial):
    def __init__(
            ...
            clearcoat_roughness=0.0, specular_tint=0.0, anisotropic=0.0,
            anisotropic_rotation=0.0, sheen=0.0, sheen_tint=0.5, ior=1.45,
            transmission=0.0, transmission_roughness=0.0, emission=(0, 0, 0, 0),
            emission_strength=0.0, alpha=1.0, base_color=(0, 0, 0, 1),
        ...
        super().__init__(
            ...
            clearcoat_roughness=clearcoat_roughness, specular_tint=specular_tint,
            anisotropic=anisotropic, anisotropic_rotation=anisotropic_rotation,
            sheen=sheen, sheen_tint=sheen_tint, ior=ior, transmission=transmission,
...
class MetalWireframeMaterial(PrincipledBSDFWireframeMaterial):
    def __init__(
            ...
            specular_tint=0.0, anisotropic=0.0, anisotropic_rotation=0.0, sheen=0.0,
            sheen_tint=0.5, ior=1.45, transmission=0.0, transmission_roughness=0.0,
